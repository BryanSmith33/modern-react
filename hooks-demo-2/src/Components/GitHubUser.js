...
const GitHubUser = ({ user }) => {
	...
	// useEffect is like componentDidMount in that this function will run once the component mounts. We pass in a array of [user]. This tells useEffect to check and see if user on state has changed. If it has, it will run the getUser() function again. If it hasn't changed, the function takes the previous result
	useEffect(() => {
		getUser()
	}, [user])
	return (
